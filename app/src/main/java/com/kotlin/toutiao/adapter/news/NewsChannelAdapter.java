package com.kotlin.toutiao.adapter.news;
...
public class NewsChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int TYPE_OTHER_HEADER = 2;//隐藏频道
    public static final int TYPE_OTHER = 3;//隐藏频道子view
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_MY_HEADER:
                view = mInflater.inflate(R.layout.item_channel_my_header, null);
            ...
            case TYPE_OTHER:
                ...
                otherHolder.textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (!isEditMode || mMyChannelItems.size() >= 15) return;
                        RecyclerView recyclerView = ((RecyclerView) parent);
                        RecyclerView.LayoutManager manager = recyclerView.getLayoutManager();
  ...
  /*      int visibleChildCount = recyclerView.getChildCount();
    ...
    private void startEditMode(RecyclerView recyclerView) {
        ...
        notifyDataSetChanged();
/*
        int visibleChildCount = recyclerView.getChildCount();//获取可见的子view数量
        for (int i = 0; i < visibleChildCount; i++) {
            View view = recyclerView.getChildAt(i);
            ImageView imgEdit = view.findViewById(R.id.img_edit);
            if (imgEdit != null) {
