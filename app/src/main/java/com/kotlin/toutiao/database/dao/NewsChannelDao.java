package com.kotlin.toutiao.database.dao;
...
import com.kotlin.toutiao.database.DatabaseHelper;
...
public class NewsChannelDao {
    ...
    public void addInitData() {
        String categoryId[] = UIUtils.getStringArray(R.array.mobile_news_id);
        String categoryName[] = UIUtils.getStringArray(R.array.mobile_news_name);
        for (int i = 0; i < 8; i++) {
